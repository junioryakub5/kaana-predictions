...
// ── Exchange rate: 1 GHS → NGN ────────────────────────────────────────────────
const GHS_TO_NGN = 125;

// ── Flutterwave public key ─────────────────────────────────────────────────────
const FLW_PUBLIC_KEY =
  process.env.NEXT_PUBLIC_FLW_PUBLIC_KEY ||
  "FLWPUBK-XXXXXXXXXXXXXXXXXXXXXXXX-X"; // Replace with your FLW public key
    ...
    <>
      <div className="px-5 pt-3">
        <button
          ...
          style={{ height: "120px", background: "rgba(17,17,23,0.8)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px" }}
        >
          ...
          >
            <span
              ...
              style={{ background: "#ff4500", color: "#ffffff", borderRadius: "10px", fontFamily: "'Sora', sans-serif", textTransform: "uppercase", letterSpacing: "0.04em", fontSize: "0.65rem" }}
            >
      ...
      {open && (
        ...
        >
          <button
            ...
            style={{ background: "rgba(255,69,0,0.9)", boxShadow: "0 0 16px rgba(255,69,0,0.4)" }}
          >
            <X size={18} />
          </button>
...
const ACCENT: Record<string, { bg: string; text: string; glow: string; border: string }> = {
  "2+":  { bg: "rgba(255,69,0,0.08)",  text: "#ff4500", glow: "rgba(255,69,0,0.2)",  border: "rgba(255,69,0,0.22)" },
  "5+":  { bg: "rgba(255,112,43,0.08)", text: "#ff7043", glow: "rgba(255,112,43,0.2)", border: "rgba(255,112,43,0.22)" },
...
const lsKey    = (id: string) => `kp_unlocked_${id}`;
const lsRefKey = (id: string) => `kp_ref_${id}`;
...
function CountrySelectModal({
  ...
  return (
    ...
    >
      <div className="absolute inset-0 backdrop-blur-md" style={{ background: "rgba(9,9,11,0.75)" }} />
      <div
        className="relative w-full max-w-sm overflow-hidden shadow-2xl"
        style={{ background: "rgba(17,17,23,0.95)", border: "1px solid rgba(255,69,0,0.12)", borderRadius: "20px", backdropFilter: "blur(24px)" }}
        onClick={(e) => e.stopPropagation()}
      >
        {/* Accent strip */}
        <div className="h-0.5 w-full" style={{ background: `linear-gradient(90deg, ${acc.text}, #ff7043)` }} />

        {/* Header */}
        <div className="px-6 pt-5 pb-4" style={{ borderBottom: "1px solid rgba(255,69,0,0.08)" }}>
          <div className="flex items-center justify-between">
            <div>
              <h2 className="font-semibold text-base" style={{ color: "#f4f4f5", fontFamily: "'Sora', sans-serif" }}>Choose your country</h2>
              <p className="text-xs mt-0.5" style={{ color: "#52525b" }}>Select to continue with payment</p>
            </div>
        ...
        <div className="px-6 py-5 space-y-3">
          ...
          <button
            ...
            style={{ background: "rgba(17,17,23,0.7)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "16px" }}
          >
            <div className="flex items-center gap-3">
              <span className="text-2xl">🇬🇭</span>
              <div className="text-left">
                <p className="font-semibold text-sm" style={{ color: "#f4f4f5" }}>Ghana</p>
                <p className="text-xs" style={{ color: "#52525b" }}>GHS {prediction.price} — Mobile Money / Card</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-xs" style={{ color: "#52525b" }}>₦{ngn.toLocaleString()} — Card / Bank Transfer / USSD</p>
              </div>
            </div>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#52525b" strokeWidth="2.5"><path d="M9 18l6-6-6-6"/></svg>
          </button>
        ...
        <div className="px-6 pb-5">
          <button
            ...
            style={{ background: "rgba(17,17,23,0.7)", color: "#71717a", borderRadius: "12px", border: "1px solid rgba(255,255,255,0.05)" }}
          >
            Cancel
          </button>
        </div>
  ...
  if (step === "verifying") {
    return (
      <div className="fixed inset-0 z-[200] flex items-center justify-center p-4" style={{ overscrollBehavior: "contain" }}>
        <div className="absolute inset-0 backdrop-blur-md" style={{ background: "rgba(9,9,11,0.7)" }} />
        <div
          className="relative w-full max-w-sm overflow-hidden shadow-2xl flex flex-col items-center justify-center gap-5 py-14 px-8"
          style={{ background: "rgba(17,17,23,0.9)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "20px", backdropFilter: "blur(24px)" }}
        >
          <div className="h-0.5 w-full absolute top-0 left-0" style={{ background: `linear-gradient(90deg, ${acc.text}, #ff7043)` }} />
          <div
    ...
    >
      ...
      >
        ...
        <div className="px-6 pt-5 pb-4" style={{ borderBottom: "1px solid rgba(255,69,0,0.08)" }}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 flex items-center justify-center text-base" style={{ background: acc.bg, border: `1px solid ${acc.border}`, borderRadius: "10px" }}>🇳🇬</div>
              <div>
                <h2 className="font-semibold text-sm" style={{ color: "#f4f4f5", fontFamily: "'Sora', sans-serif" }}>Nigeria Payment</h2>
                <p className="text-xs" style={{ color: "#52525b" }}>Powered by Flutterwave · NGN</p>
              </div>
            </div>
            <button onClick={onClose} style={{ color: "#52525b" }}><X size={18} /></button>
          </div>
        ...
        <div className="px-6 mt-5 space-y-3 pb-6">
          <div>
            <label className="block text-xs font-medium mb-1.5" style={{ color: "#71717a", fontFamily: "'Sora', sans-serif", letterSpacing: "0.04em", textTransform: "uppercase", fontSize: "0.6rem" }}>Your email address</label>
            <input
              type="email"
          ...
          <button
            ...
            style={{
              background: step === "paying" ? "rgba(255,69,0,0.3)" : `linear-gradient(135deg, ${acc.text}, #cc3600)`,
              color: "#ffffff",
...
function PaymentModal({
    ...
    return (
      <div className="fixed inset-0 z-[200] flex items-center justify-center p-4" style={{ overscrollBehavior: "contain" }}>
        ...
        >
          ...
          <div className="text-center">
            <p className="font-semibold text-base mb-1" style={{ color: "#f4f4f5" }}>Verifying Payment…</p>
            <p className="text-xs" style={{ color: "#52525b" }}>Confirming with Paystack and unlocking your prediction</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4" onClick={onClose} style={{ overscrollBehavior: "contain" }}>
      ...
      <div
        className="relative w-full max-w-sm overflow-hidden shadow-2xl"
        style={{ background: "rgba(17,17,23,0.92)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "20px", backdropFilter: "blur(24px)" }}
        onClick={(e) => e.stopPropagation()}
      >
        {/* Accent strip */}
        <div className="h-0.5 w-full" style={{ background: `linear-gradient(90deg, ${acc.text}, #ff7043)` }} />
          ...
          <div className="flex items-start justify-between gap-3">
            <div>
              <span
                ...
                style={{ background: acc.bg, color: acc.text, border: `1px solid ${acc.border}`, borderRadius: "8px", fontFamily: "'Sora', sans-serif", letterSpacing: "0.05em", textTransform: "uppercase" }}
              >
                {prediction.oddsCategory} ODDS
              </span>
              <h2 className="font-semibold text-base leading-snug" style={{ color: "#f4f4f5" }}>{prediction.match}</h2>
              <p className="text-xs mt-0.5 flex items-center gap-1.5" style={{ color: "#52525b" }}>
                <Calendar size={11} />
                {new Date(prediction.date).toLocaleDateString("en-GB", { weekday: "short", day: "numeric", month: "short" })}
                {" · "}{prediction.league}
              </p>
            </div>
            <button onClick={onClose} className="transition-colors mt-0.5 flex-shrink-0" style={{ color: "#52525b" }}>
              <X size={18} />
            </button>
          </div>
        </div>
        ...
        {tab === "pay" ? (
          <>
            ...
            >
              <div>
                <p className="text-xs mb-0.5" style={{ color: "#52525b" }}>Access Price</p>
                <p className="text-2xl font-bold" style={{ color: "#f4f4f5" }}>
                  GHS <span style={{ color: acc.text }}>{prediction.price}</span>
                </p>
              </div>
              <div className="text-right">
                <p className="text-xs mb-0.5" style={{ color: "#52525b" }}>Total Odds</p>
            ...
            <div className="px-6 pb-6 space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 font-bold text-sm py-3.5 transition-all duration-300 active:scale-[0.97]"
                style={{
                  background: step === "paying" ? "rgba(255,69,0,0.3)" : "linear-gradient(135deg, #ff4500, #cc3600)",
                  color: "#ffffff",
                  boxShadow: step === "paying" ? "none" : "0 0 20px rgba(255,69,0,0.3), 0 4px 16px rgba(255,69,0,0.2)",
                  borderRadius: "12px",
                  fontFamily: "'Sora', sans-serif",
                  letterSpacing: "0.04em",
                  textTransform: "uppercase",
                  fontSize: "0.8rem",
                  border: step === "paying" ? "none" : "1px solid rgba(255,69,0,0.4)",
                }}
              >
                {step === "paying"
          ...
          <div className="px-6 py-6 space-y-4">
            <div
              ...
              style={{ background: "rgba(255,69,0,0.06)", border: "1px solid rgba(255,69,0,0.15)", borderRadius: "12px" }}
            >
              <Mail size={16} className="flex-shrink-0 mt-0.5" style={{ color: "#ff4500" }} />
            ...
            <div>
              <label className="block text-xs font-medium mb-1.5" style={{ color: "#71717a", fontFamily: "'Sora', sans-serif", letterSpacing: "0.04em", textTransform: "uppercase", fontSize: "0.6rem" }}>Email used at payment</label>
              <input
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 font-bold text-sm py-3.5 transition-all duration-300 active:scale-[0.97]"
              style={{
                background: restoreLoading ? "rgba(168,85,247,0.3)" : "linear-gradient(135deg, #a855f7, #7e22ce)",
                color: "#ffffff",
                boxShadow: restoreLoading ? "none" : "0 0 20px rgba(168,85,247,0.3), 0 4px 16px rgba(168,85,247,0.2)",
                borderRadius: "12px",
                fontFamily: "'Sora', sans-serif",
                letterSpacing: "0.04em",
                textTransform: "uppercase",
                fontSize: "0.8rem",
                border: restoreLoading ? "none" : "1px solid rgba(168,85,247,0.4)",
              }}
            >
              {restoreLoading
  ...
  return (
    <div className="card-glass overflow-hidden">
      ...
      >
        ...
        <span className="text-xs font-semibold" style={{ color: "#10b981", fontFamily: "'Sora', sans-serif", letterSpacing: "0.04em", textTransform: "uppercase", fontSize: "0.65rem" }}>Prediction Unlocked ✓</span>
        <span
      ...
      <div className="px-5 pt-4">
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold" style={{ color: acc.text, fontFamily: "'Sora', sans-serif", letterSpacing: "0.04em", textTransform: "uppercase", fontSize: "0.65rem" }}>
                  {unlocked.bookingCode ? "Booking Code" : "Prediction Tip"}
                </span>
              </div>
              <button onClick={copyCode} className="flex items-center gap-1 text-xs transition-colors" style={{ color: "#52525b" }}>
                {copied ? <><Check size={11} style={{ color: "#10b981" }} />Copied!</> : <><Copy size={11} />Copy</>}
              </button>
            </div>
            <p className="font-bold text-xl tracking-widest text-center py-2" style={{ color: acc.text, fontFamily: "monospace", letterSpacing: "0.15em" }}>
              {unlocked.bookingCode || unlocked.content}
            </p>
          </div>
        )}
        ...
        {unlocked.tips && unlocked.tips.length > 0 && (
          <div className="mb-4 space-y-1.5">
            <p className="text-xs font-medium mb-2" style={{ color: "#52525b", fontFamily: "'Sora', sans-serif", letterSpacing: "0.04em", textTransform: "uppercase", fontSize: "0.6rem" }}>What to bet:</p>
            {unlocked.tips.map((tip, i) => (
              <div
                key={i}
                className="flex items-center gap-2 px-3 py-2 text-xs"
                style={{ background: "rgba(17,17,23,0.6)", border: "1px solid rgba(255,255,255,0.04)", color: "#a1a1aa", borderRadius: "10px" }}
              >
      ...
      <div className="relative h-52 overflow-hidden" style={{ background: "rgba(17,17,23,0.8)" }}>
        {hasImage ? (
          ...
          <div
            ...
            style={{ background: `linear-gradient(135deg, ${acc.bg} 0%, rgba(17,17,23,0.9) 100%)` }}
          />
        )}
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-3">
          <div
            className="w-14 h-14 flex items-center justify-center transition-all duration-300 md:group-hover:scale-110 animate-glow-pulse"
            style={{
              background: "rgba(17,17,23,0.7)",
              border: `1px solid ${acc.border}`,
              borderRadius: "16px",
      ...
      <div className="px-5 py-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            <span className="text-xs" style={{ color: "#52525b" }}>Odds:</span>
            <span className="font-bold text-sm" style={{ color: acc.text }}>{prediction.odds}</span>
          </div>
          <span className="font-bold text-lg" style={{ color: "#10b981" }}>GHS {prediction.price}</span>
        </div>
